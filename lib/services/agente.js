...
function fichaProducto(p) {
  ...
  if (variantes.length) {
    // El stock real vive en cada variante: la disponibilidad general se
    // muestra por combinacion abajo, no como un solo numero del producto
    // (que suele quedar en 0 a proposito cuando el producto usa variantes).
...
module.exports = {
  ...
  respuestaErrorTecnico, seccionProductos,
};
