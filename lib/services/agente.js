...
NO repitas los datos de la ficha en texto. Tu texto ahora: reaccion breve de por que le conviene + CIERRE empujando el pedido. Nunca termines con "¿que te parecio?".`;
}
...
function categoriaDelLead(productos, lead = {}) {
  ...
  return productos.find((p) => p.categoria?.id === lead.categoriaId)?.categoria || null;
}
