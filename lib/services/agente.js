  ...
  try {
    for (let vuelta = 0; vuelta < MAX_VUELTAS; vuelta++) {
      ...
      if (!resp.tool_calls?.length) {
        ...
        if (!esUltimaVuelta) {
        ...
        } else if (pidiendoPreferencia || nombrado || listadoEnTexto || interrogatorio || anuncioDeBusqueda || faltaStockFalsa || llamadaEnTexto || afirmoSinMostrar || debioLlamarTarjetaCategoria || falloInventado || plazoEntregaInventado) {
          ...
          logEtapa('texto_vago_forzado_en_ultima_vuelta', telefonoCliente, { vuelta, pidiendoPreferencia, nombrado, listadoEnTexto, interrogatorio, anuncioDeBusqueda, faltaStockFalsa, llamadaEnTexto, afirmoSinMostrar, debioLlamarTarjetaCategoria, falloInventado, plazoEntregaInventado, yaEnCierre });
...
module.exports = {
  ...
  afirmaFaltaDeStockSinRespaldo, afirmaQueMostroAlgoSinTarjeta, afirmaFalloTecnicoInventado, afirmaPlazoDeEntregaInventado, pareceQuererCatalogoCompleto, pareceQuererVerOtraCosa, pareceLlamadaDeHerramientaEnTexto,
};
