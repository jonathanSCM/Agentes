...
async function generarRespuesta(agenteId, telefonoCliente, historial, mensajeCliente, conversacionId, opciones = {}) {
  ...
  const helpers = { empresaId: empresa.id, empresaSlug: empresa.slug, telefonoCliente, conexion: opciones.modoPrueba ? null : agente.conexion, fotosParaMostrar, conversacionId, baseUrl: opciones.baseUrl, config: agente.config, moneda: empresa.moneda || 'BOB', turno, mensajeCliente };
  ...
  if (pareceQuererCatalogoCompleto(mensajeCliente) && !productoNombradoPorCliente) {
        ...
        if (!esUltimaVuelta) {
          ...
          if (yaEnCierre) {
            ...
            if (pareceQuererVerOtraCosa(mensajeCliente) || detectados.categoriaId) {
              ...
              const quiereCatalogoCompletoAca = pareceQuererCatalogoCompleto(mensajeCliente);
...
module.exports = {
  ...
  afirmaFaltaDeStockSinRespaldo, afirmaQueMostroAlgoSinTarjeta, afirmaFalloTecnicoInventado, afirmaPlazoDeEntregaInventado, mencionaModeloInventado, pareceQuererCatalogoCompleto, pareceQuererVerOtraCosa, pareceLlamadaDeHerramientaEnTexto,
};
