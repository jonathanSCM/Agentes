...
${lineas}
Cuando preguntes por alguno de estos, OFRECE estas opciones concretas ("¿lo buscas en negro, blanco o gris?"). PROHIBIDO preguntar al aire ("¿que color preferis?") sin decirle cuales hay, y prohibido responder "decime que color te gusta" si el cliente pregunta cuales tenes: se los decis.
`;
}
...
module.exports = {
  ...
  contextoReiniciadoPorInactividad, nombraUnProductoReal,
};
