...
function seccionProductos(productos, lead = {}, categoria = null, moneda = 'BOB', config = null, yaEligioOCerrando = false) {
...
${seccionProductos(productos, lead, categoriaActual, moneda, config, yaEligioOCerrando)}
    ...
    for (let vuelta = 0; vuelta < MAX_VUELTAS; vuelta++) {
      ...
      if (!resp.tool_calls?.length) {
        ...
        if (!esUltimaVuelta) {
          ...
          logEtapa('texto_vago_forzado_en_ultima_vuelta', telefonoCliente, { vuelta, pidiendoPreferencia, nombrado, listadoEnTexto, interrogatorio, anuncioDeBusqueda, yaEnCierre });
