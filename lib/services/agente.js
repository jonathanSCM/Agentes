...
// (primero exactos, si no hay relaja presupuesto, si no relaja categoria).
// Se usa tambien en ejecutarFuncion para FORZAR en codigo que el modelo
// muestre todos estos productos con tarjeta - no alcanza con pedirselo por
// texto en el prompt, la IA a veces solo llama mostrar_productos con uno y
// describe el resto en su mensaje, rompiendo la regla de "todo va en tarjeta".
function productosCandidatosAMostrar(productos, lead = {}) {
  ...
  return buscarProductosFiltrados(productos, lead, { ignorarCategoria: true });
}
