 ...
 */
async function generarYRegistrarRespuesta(agenteId, telefonoCliente, conversacionId, contenido, baseUrl) {
  ...
  const salida = await generarRespuesta(agenteId, telefonoCliente, historial, contenido, conversacionId, { baseUrl });
 ...
 */
async function atenderMensaje({ agenteId, telefonoCliente, contenido, baseUrl }) {
  ...
  const salida = await generarYRegistrarRespuesta(agenteId, telefonoCliente, entrada.conversacionId, contenido, baseUrl);
