...
const MOTIVOS_LEGIBLES = {
  ...
  SUSCRIPCION_INACTIVA: 'tu suscripción no está activa y ya no te queda saldo de conversaciones',
  SUSCRIPCION_CANCELADA: 'tu suscripción está cancelada',
  PERIODO_VENCIDO: 'tu período venció y ya no te queda saldo de conversaciones',
