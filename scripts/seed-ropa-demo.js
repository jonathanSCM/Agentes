...
const PRODUCTOS_ROPA = [
  {
    ...
    precio: 80,
    caracteristicas: ['Corte clásico', 'Cuello redondo'],
    atributos: { Marca: 'Basicos BO', Material: 'Algodón 100%' },
  ...
  },
  {
    ...
    precio: 110,
    caracteristicas: ['Corte oversize', 'Unisex'],
    atributos: { Marca: 'Urbana', Material: 'Algodón peinado' },
  ...
  },
  {
    ...
    precio: 150,
    caracteristicas: ['Puños ajustables', 'Bolsillos con cierre'],
    atributos: { Marca: 'ActivFit', Material: 'Tela elástica' },
  ...
  },
  {
    ...
    precio: 190,
    caracteristicas: ['Capucha ajustable', 'Bolsillo canguro'],
    atributos: { Marca: 'Urbana', Material: 'Interior afelpado' },
  ...
  },
  {
    ...
    precio: 160,
    caracteristicas: ['Corte suelto', 'Manga corta'],
    atributos: { Marca: 'Basicos BO', Material: 'Tela liviana' },
  ...
  },
  {
    ...
    precio: 220,
    caracteristicas: ['Botones metálicos', 'Corte clásico'],
    atributos: { Marca: 'DenimCo', Material: 'Mezclilla resistente' },
